...
import TOBA.business.data.TransactionDB;
        ...
        try {
            ...
            if (account.equals("saving")) {
                ...
                if (transaction.equals("Credit")) {
                    ...
                    saving.setAccountType(Account.AccountType.accountsavings);
                    AccountDB.UpdateAccount(saving);
                    Transactions tran = new Transactions((int) saving.getAccountId(), balance, "credit");
                ...
                if (transaction.equals("Debit")) {
                    ...
                    saving.setAccountType(Account.AccountType.accountsavings);
                    AccountDB.UpdateAccount(saving);
                    Transactions tran = new Transactions((int) saving.getAccountId(), balance, "Debit");
                    tran.setTime(dateFormat.format(date));
            ...
            if (account.equals("checking")) {
                ...
                if (transaction.equals("Credit")) {
                    ...
                    checking.setAccountType(Account.AccountType.Checkings);
                    AccountDB.UpdateAccount(checking);
                    Transactions tran = new Transactions((int) checking.getAccountId(), balance, "credit");
                    tran.setTime(dateFormat.format(date));
                    transactionDb.insertTranction(tran, "Credit");
                }
                if (transaction.equals("Debit")) {
                    ...
                    checking.setAccountType(Account.AccountType.Checkings);
                    AccountDB.UpdateAccount(checking);
                    Transactions tran = new Transactions((int) checking.getAccountId(), balance, "Debit");
                    tran.setTime(dateFormat.format(date));
                    transactionDb.insertTranction(tran, "Debit");
